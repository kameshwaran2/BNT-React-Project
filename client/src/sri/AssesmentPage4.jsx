...
export default function AssessmentPage4() {
  const API_URL = "http://localhost:3300/dataSufficiencyQuestions"; 
...
// 1.changed
  ...
  const finalScoreData = {
    category: "Data Sufficiency", // 👈 change this per assessment
    score: score,
    total: quiz.length,
  };
  ...
  {/* 2.changed       */}
        <p className="fs-5 mb-2"><strong>{currentQ.question}</strong></p>
            <ul className="mb-3">
               <li><strong>Statement I:</strong> {currentQ.statement1}</li>
            <li><strong>Statement II:</strong> {currentQ.statement2}</li>
            </ul>
